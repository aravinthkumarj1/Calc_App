...
public class MainActivity extends AppCompatActivity {
    ...
    public static MyService.LogsUtils LogsUtils;
    Button button0;
    Button button1;
    Button button2;
    Button button3;
    ...
    static class LogsUtil {
        ...
        public static StringBuilder readLogs() {
            ...
            try {
                ...
                Process processclean = Runtime.getRuntime().exec(command);
    ...
    private void onEqualButtonClicked() {
        int res = 0;
        Log.d(TAG, "Aravinth:test1: ");
        StringBuilder logs = LogsUtil.readLogs();
        if(logs.toString().contains("MediaCodec"))
            Log.d(TAG, "Aravinth:Matched: ");
        else
    ...
    private void onClearButtonClicked() {
        result = "";
        Log.i(TAG, "Aravinth:MediaCodec: (0x6c08a580) flush ");
